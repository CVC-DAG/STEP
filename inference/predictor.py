...
class VisualizationDemo(object):
    def __init__(self, cfg, instance_mode=ColorMode.IMAGE, parallel=False):
        ...
        if parallel:
            ...
            self.predictor = StepPredictor(cfg)

    def run_on_image(self, image, query):
        """
        Args:
        ...
        """
        vis_output = None
        predictions = self.predictor(image, query)
...
class StepPredictor(DefaultPredictor):
    """
        heeh
    """

    def __init__(self, cfg):
        super(StepPredictor, self).__init__(cfg)

    def __call__(self, original_image, query):
        """
            (...)
        """
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            predictions = self.model.forward_query([inputs], query)[0]
            return predictions
